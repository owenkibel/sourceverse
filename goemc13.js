...
//...
        ...
        // Side-effect: Create a 60-second MP3 snippet for Jamify
        ...
        try {
            ...
            console.log(`Successfully created 60-second snippet: ${snippetPath}`);
        } catch (ffmpegError) {
...
async function processSingleFile(inputFile, selectedPrompt) {
    ...
    try {
        ...
        const musicGenResult = await generateMusicWithComfyUI({
            ...
            negative_tags: ACE_STEP_NEGATIVE_TAGS // <-- USE THE HARD-CODED CONSTANT HERE
        });
