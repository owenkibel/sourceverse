...
// // Snippet settings for the 'current.mp3' file created from YouTube audio
// const SNIPPET_START_TIME_SECONDS = 0; // Start the snippet 30 seconds into the track
// const SNIPPET_DURATION_SECONDS = 30; // Create a 60-second snippet

// // Jamify creative settings
// const JAMIFY_VAE_TYPE = "diffrhythm"; // "stable_audio" for high fidelity, "diffrhythm" for default
// const JAMIFY_USE_PROMPT_STYLE = false; // Let text prompt have more influence on style? (true/false)
...
function removeBoilerplate(text) {
    ...
    const patternsToRemove = [
        ...
        /get chrome/gi,
        // Add any other common boilerplate patterns here
        /sign in/gi,
        /privacy policy/gi,
        /terms of service/gi,
    ];
    ...
    // Clean up any resulting extra whitespace or empty lines
...
async function processSingleFile(inputFile, selectedPrompt) {
    ...
    try {
        ...
        // --- PRE-PROCESS THE TEXT: Remove boilerplate before sending to the LLM ---
