...
Two small Bash scripts are included to streamline the process of dealing with the json outputs of the Bookmarklets above. Edit the 

```bash
# Define the paths
downloads_dir="/path/to"
```
part of the jsonlscript.sh and jsonxscript.sh files to point to the location of the Chrome Browser Downloads folder.
