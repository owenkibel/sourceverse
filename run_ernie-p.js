...
function buildPayload(promptText, seed) {
    ...
    return {
        ...
        "prompt": {
            ...
            "88:71": { "inputs": { "width": 1024, "height": 1024, "batch_size": 1 }, "class_type": "EmptyFlux2LatentImage" },
            ...
            "88:96": { "inputs": { "value": false }, "class_type": "PrimitiveBoolean" },
            ...
            "88:99": { "inputs": { "preview_markdown": "1024", "preview_text": "1024", "previewMode": null, "source": 1024 }, "class_type": "PreviewAny" },
            "88:100": { "inputs": { "preview_markdown": "1024", "preview_text": "1024", "previewMode": null, "source": 1024 }, "class_type": "PreviewAny" },
