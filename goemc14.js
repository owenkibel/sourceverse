...
// This new regex flexibly handles prefixes like "###" or "Part 3:" and makes them optional.
const match = youtubeAnalysisResult.rawText.match(/(?:#+\s*|Part \d+:\s*)?Music Tags:([\s\S]*?)(?=###|$)/i);
if (match && match[1]) {
    ...
    // --- Define Your Jamify Configuration Object Here ---
    const jamifyConfig = {
        evaluation: {
            vae_type: "diffrhythm", // or "stable_audio"
            num_style_secs: 30,      // Use 60 seconds of the style audio
            use_prompt_style: false, // Set to true if you want text prompts to have more influence
        }
    };
